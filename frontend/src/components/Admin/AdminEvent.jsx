  ...
  return (
    <div className="mt-24 px-6 mb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        <div>
          <h1 className="text-4xl font-black text-foreground tracking-tight">Manage Announcements</h1>
          <p className="text-muted-foreground font-medium mt-1">Schedule and organize spiritual updates and news</p>
        </div>
