...
const DonationCampaignCard = ({
  ...
  return (
    <div className="border min-h-60 w-68 p-5 shadow-lg rounded-lg m-10 bg-white opacity-95 animate-scaleIn hover-scale">
      ...
      {(role === "churchMember" || role === "externalMember") && (
        <button
          ...
          className="mt-4 mx-auto block text-sm font-bold w-20 border-2 hover:opacity-40 rounded"
        >
          Donate
        </button>
      )}
